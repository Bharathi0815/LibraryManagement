    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <form:input type="text" id="firstName" path="firstName"   class="form-control" required="required" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <form:input type="text" id="bookName" path="bookName"  class="form-control" required="required"/>
        </div>
        <div class="form-group">
